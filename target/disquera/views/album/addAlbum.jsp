...
<body>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../genero/addGenero.jsp">Add Genero</a></li>
                                <li><a href="../genero/editGenero.jsp">Edith Genero</a></li>
                                <li><a href="../genero/listGenero.jsp">List Genero</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    <section  id="formulario">
        <center>
             <h2>REGISTRAR ÁLBUM</h2> <br> <br> <br>
                <form action="album" method="POST">
                        
                        
                            <div class="form">
                                <div class="grupo">
                                    <input type="text" name="nombreAlbum" id="nombreAlbum" required="required"><span class="barra"></span>
                                    <label>Nombre Álbum: </label>
                                </div>
                                <div class="grupo">
                                    <input type="number" name="anioPublicacion" id="anioPublicacion" required="required"><span class="barra"></span>
                                    <label>Año Publicación:  </label>
                                </div>
                                <div class="grupo">

                                    <input class="form-check-input" type="checkbox" name="estadoAlbum" id="estadoAlbum" checked>
                                    <label class="form-check-label" for="estadoAlbum">Activo</label>
