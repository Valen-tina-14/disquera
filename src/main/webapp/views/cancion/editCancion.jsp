    ...
    <section  id="formulario">
        <center>
            <c:forEach var="canciones" items="${canciones}">
             <h2>EDITAR CANCIÓN "${canciones.getNombreCancion()}"</h2> <br> <br> <br>
                <form action="cancion" method="POST">
                        
                        
                            <div class="form">
                                <div class="grupo">
                                    <input type="text" name="nombreCancion" required="required" value="${canciones.getNombreCancion()}"><span class="barra"></span>
                                    <input type="text" name="idCancion" required="required" value="${canciones.getIdCancion()}"><span class="barra"></span>
                                    <label>Nombre Álbum: </label>
                                </div>
                                <div class="grupo">
                                    <input type="number" name="fechaGrabacion" required="required" value="${canciones.getFechaGrabacion()}"><span class="barra"></span>
                                    <label>Fecha Grabación:  </label>
                                </div>
                                <div class="grupo">
                                    <input type="number" name="duracionGrabacion" required="required" value="${canciones.getDuracionGrabacion()}"><span class="barra"></span>
                                    <label>Duración Grabación:  </label>
                                </div>
                                <div> <br>
                                    <div class="grupo">

                                        <input class="form-check-input" type="checkbox" name="estadoCancion" id="estadoCancion" value="${canciones.isEsatdoCancion()}" checked>
                    ...
                    <div class="text-center">
                        ...
                        <button class="button" id="sendMessageButton" type="submit" name="accion" value="editar">EDITAR CANCIÓN</button>
                    </div>
                </form>
            </div>
            </center>
